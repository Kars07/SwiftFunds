...
const KeyFeatures: React.FC = () => {
  ...
  return (
    <div className="md:py-30 pb-0 px-5 mt-20 overflow-hidden">
      ...
      <div>
        <div>
          <h1 className="text-black font-medium text-3xl pt-10 pb-5">🔁 Dual Roles</h1>
          <h2>
        ...
        <div className="justify-center flex flex-col items-center">
          <h1 className="text-black font-medium text-3xl pt-10 pb-5">📤 Blockchain Submissions</h1>
          <h2>
        ...
        <div className="justify-end flex flex-col items-end">
          <h1 className="text-black font-medium text-3xl pt-10 pb-5 transform -translate-x-17">⏳ Timely Repayment</h1>
          <h2>
