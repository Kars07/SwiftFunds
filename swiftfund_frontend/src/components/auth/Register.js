          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center mt-4">
              <button
                type="submit"
                disabled={loading}
                className={`bg-white border-2 border-orange-500 text-orange-500 font-bold py-2 px-4 rounded-lg w-1/2 cursor-pointer hover:bg-blue-600 hover:text-white transition-colors duration-300 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
